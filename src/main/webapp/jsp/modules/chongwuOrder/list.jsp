    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(chongwuJiankangTypesCell);
                    ...
                    //所在地
            var chongwuSuozaidiCell = document.createElement('td');
            chongwuSuozaidiCell.innerHTML = item.chongwuSuozaidi;
            row.appendChild(chongwuSuozaidiCell);


            //         //领养要求
            // var chongwuLingyangyaoqiuCell = document.createElement('td');
            // chongwuLingyangyaoqiuCell.innerHTML = item.chongwuLingyangyaoqiu;
            // row.appendChild(chongwuLingyangyaoqiuCell);
            //
            //
            //         //联系方式
            // var chongwuLianxifangshiCell = document.createElement('td');
            // chongwuLianxifangshiCell.innerHTML = item.chongwuLianxifangshi;
            // row.appendChild(chongwuLianxifangshiCell);
            //
            //
            //     //宠物照片
            // var chongwuPhotoCell = document.createElement('td');
            // var chongwuPhotoImg = document.createElement('img');
            // var chongwuPhotoImgValue = item.chongwuPhoto;
            // if(chongwuPhotoImgValue !=null && chongwuPhotoImgValue !='' && chongwuPhotoImgValue !='null'){
            //         chongwuPhotoImg.setAttribute('src', chongwuPhotoImgValue);
            //         chongwuPhotoImg.setAttribute('height', 100);
            //         chongwuPhotoImg.setAttribute('width', 100);
            //         chongwuPhotoCell.appendChild(chongwuPhotoImg);
            // }else{
            //         chongwuPhotoCell.innerHTML = "暂无图片";
            // }
            // row.appendChild(chongwuPhotoCell);
            //
            //
            //         //宠物详情
            // var chongwuContentCell = document.createElement('td');
            // //如果图文详情包含图片
            // if (item.chongwuContent && item.chongwuContent.indexOf('img') != -1) {
            //     //暂时只考虑图片+文字 和 文字+图片的情况
            //     var beginIndex = item.chongwuContent.indexOf('<img');
            //     var endIndex = item.chongwuContent.indexOf('>');
            //         chongwuContentCell.innerHTML = item.chongwuContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            // } else {
            //     if (item.chongwuContent != null && item.chongwuContent != "" && item.chongwuContent.length >= 11) {
            //             chongwuContentCell.innerHTML = item.chongwuContent.substring(0, 10) + "...";
            //     } else {
            //             chongwuContentCell.innerHTML = item.chongwuContent;
            //     }
            // }
            // row.appendChild(chongwuContentCell);
            //
            //             //是否被领养
            ...
            //宠物订单状态
            var chongwuOrderTypesCell = document.createElement('td');
            chongwuOrderTypesCell.innerHTML = item.chongwuOrderValue;
            row.appendChild(chongwuOrderTypesCell);
