                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>宠物订单状态</label>
                                        <select id="chongwuOrderTypesSelect" name="chongwuOrderTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    // 查询列表
        <!-- 查询当前表的所有列表 -->
        function chongwuOrderTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=chongwu_order_types", "GET", {}, (res) => {
                if(res.code == 0){
                    chongwuOrderTypesOptions = res.data.list;
                }
            });
        }
        <!-- 查询级联表的所有列表 -->
    ...
    // 初始化下拉框
    <!-- 初始化当前表的下拉框 -->
        function initializationChongwuordertypesSelect(){
            var chongwuOrderTypesSelect = document.getElementById('chongwuOrderTypesSelect');
            if(chongwuOrderTypesSelect != null && chongwuOrderTypesOptions != null  && chongwuOrderTypesOptions.length > 0 ){
                for (var i = 0; i < chongwuOrderTypesOptions.length; i++) {
                    chongwuOrderTypesSelect.add(new Option(chongwuOrderTypesOptions[i].indexName,chongwuOrderTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(chongwuOrderTypesSelect != null && chongwuOrderTypesOptions != null  && chongwuOrderTypesOptions.length > 0 ) {
            for (var i = 0; i < chongwuOrderTypesOptions.length; i++) {
                if (chongwuOrderTypesOptions[i].codeIndex == ruleForm.chongwuOrderTypes) {//下拉框value对比,如果一致就赋值汉字
                        chongwuOrderTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                yonghuId: "required",
                insertTime: "required",
                chongwuOrderTypes: "required",
            },
            messages: {
                chongwuId: "宠物不能为空",
                yonghuId: "用户不能为空",
                insertTime: "领养时间不能为空",
                chongwuOrderTypes: "宠物订单状态不能为空",
            }
        }).form();
    }
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            <!--  初始化当前表的下拉框  -->
            initializationChongwuordertypesSelect();
            <!--  初始化级联表的下拉框  -->
